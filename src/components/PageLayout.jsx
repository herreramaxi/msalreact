...
import { SignInButtonRedirects } from "./SignInButtonRedirects";
import { SignOutButtonPopup } from "./SignOutButtonPopup";
import { SignOutButtonRedirects } from "./SignOutButtonRedirects";
/**
    ...
    return (
        <>
            <Navbar bg="primary" variant="dark">
                ...
                {isAuthenticated ? <SignOutButtonRedirects /> : <SignInButtonRedirects />}
            </Navbar>
